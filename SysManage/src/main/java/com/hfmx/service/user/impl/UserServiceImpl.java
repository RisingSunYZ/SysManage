...
public class UserServiceImpl extends BaseServiceImpl<TUser, Serializable>
	 ...
	 */
	@Override
	public void delete(Class<TUser> userClass, Serializable id) {
	 ...
	 */
	@Override
	public void delete(Class<TUser> userClass, Serializable[] ids) {
	 ...
	 */
	@Override
	public TUser find(Class<TUser> entityClass, Serializable id) {
	 ...
	 */
	@Override
	public List<TUser> search(String hql, Map<String, Object> params) {
	 ...
	 */
	@Override
	public List<TUser> search(Class<TUser> userClass, String sql) {
	 ...
	 */
	@Override
	public long count(Class<TUser> entityClass) {
