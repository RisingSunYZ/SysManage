(function($){
	...
	_view = {
		addEditBtn: function(setting, node) {
			...
			editStr = "<span class='ztreebutton edit' id='" + node.tId + consts.id.EDIT + "' title='"+tools.apply(setting.edit.renameTitle, [setting.treeId, node], setting.edit.renameTitle)+"' treeNode"+consts.id.EDIT+" style='display:none;'></span>";
			aObj.append(editStr);
		...
		addRemoveBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			removeStr = "<span class='ztreebutton remove' id='" + node.tId + consts.id.REMOVE + "' title='"+tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle)+"' treeNode"+consts.id.REMOVE+" style='display:none;'></span>";
