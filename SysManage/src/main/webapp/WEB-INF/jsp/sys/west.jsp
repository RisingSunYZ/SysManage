...
<script type="text/javascript">
	...
	if (sessionInfo_userId) {
		layout_west_tree_url = '<%=basePath%>sys/sysmenu.do';
	}
	$(function() {
		layout_west_tree = $('#layout_west_tree').tree({
			...
			onLoadSuccess : function(node, data) {
				...
				layout_west_tree.tree('expand',RootNode.target);
			}
		});
	});
...
<div class="easyui-accordion" data-options="fit:true,border:false">
	...
	<div title="其他示例" data-options="border:false,iconCls:'anchor'">
		<ul>
			<li><a href="<%=basePath%>jsp/classes/index.do" target="center">班级管理</a></li>
			<li>菜单</li>
			<li>菜单</li>
		</ul>
	</div>
